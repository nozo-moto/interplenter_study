...
import (
	...
	"github.com/nozo-moto/interplenter_study/lexer"
...
func New(l *lexer.Lexer) *Parser {
	...
	p.registerInfix(token.BANG, p.parsePrefixExpression)
	p.registerInfix(token.MINUS, p.parsePrefixExpression)
...
func (p *Parser) peekError(t token.TokenType) {
	msg := fmt.Sprintf("expected next token to be %s, got %s insterd", t, p.peekToken.Type)
